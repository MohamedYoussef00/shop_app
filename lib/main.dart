...
import 'package:shopapp/modules/on_bording_screan/onbording_screan.dart';
import 'package:shopapp/shared/components/blocobserver.dart';
import 'package:shopapp/shared/conestantes/conestantes.dart';
import 'package:shopapp/shared/stayles/theams.dart';
...
Future<void> main() async {
  ...
  Widget wedgit=onBording==null?OnBordingScrean():token==null?LoginScrean():HomeLayout();
  runApp(MyApp(onBording,wedgit));
}
...
class MyApp extends StatelessWidget {
  ...
  final Widget wedgit;
   MyApp(this.onBording,this.wedgit) ;

  // This widget is the root of your application.
  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (BuildContext context)=>ShopCubit()..getHomeData()..getCategoriesData()..getFaveroiteData(),
